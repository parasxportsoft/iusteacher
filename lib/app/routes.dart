import 'package:eschool_teacher/ui/screens/feedback/feedback_Screen.dart';
...
class Routes {
  ...
  static const String feedbackScreen = "/feedbacks";
  ...
  static Route<dynamic> onGenerateRouted(RouteSettings routeSettings) {
    ...
    switch (routeSettings.name) {
      ...
      case feedbackScreen:
        return FeedbackScreen.route(routeSettings);
      default:
        {
