      ...
      children: [
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            return _buildMenuContainer(itemIndex: index);
          },
        ),
                  ...
                  if (state is MyClassesFetchSuccess) {
                    _menuItems = [
                      ...
                      MenuContainerDetails(
                        ...
                        iconPath: UiUtils.getImagePath("attendance_icon1.svg"),
                        title: UiUtils.getTranslatedLabel(
                      ...
                      MenuContainerDetails(
                        ...
                        iconPath: UiUtils.getImagePath("feedback.svg"),
                        title: UiUtils.getTranslatedLabel(
                            context, "Parents Feedback"),
                      ),
                    ];
