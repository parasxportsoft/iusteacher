              ...
              child: CustomDropdownButtonContainer(
                  ...
                  onTap: () async {
                    if (context.read<SessionYearCubit>().state
                      ...
                      Month? selectedMonth = await UiUtils.showBottomSheet(
      ...
      children: [
        ...
        Container(
          padding: EdgeInsets.symmetric(
              horizontal: UiUtils.screenContentHorizontalPadding, vertical: 15),
          decoration: BoxDecoration(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: _totalContainer(
                    titleKey: leavesTakenKey, total: data.leavesTaken),
              ),
            ],
          ),
        ),
